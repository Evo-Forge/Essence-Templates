...
module.exports = {
	...
	'toolbar': {
		'title': 'ToolBar',
		'description': 'It’s never been more fun to create an toolbar with button and navigation and whatever. Start with the .e-toolbar class then add buttons, menus and whatever you need.',
		'url': '/toolbar.html',
		'icon': 'editor-format-color-text'
	},
	'tooltip': {
